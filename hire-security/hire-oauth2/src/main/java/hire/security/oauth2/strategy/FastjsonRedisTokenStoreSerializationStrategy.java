package hire.security.oauth2.strategy;
...
public class FastjsonRedisTokenStoreSerializationStrategy implements RedisTokenStoreSerializationStrategy {
    ...
    protected static void init() {
        ...
        config.addAccept("com.hire.common.base.entity");
        TypeUtils.addMapping("com.hire.common.base.entity.AuthUser", AuthUser.class);
        config.addAccept("com.hire.common.base.entity");
        TypeUtils.addMapping("com.hire.common.base.entity.CommonUser", CommonUser.class);
